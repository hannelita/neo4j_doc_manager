...
neo4j_host = unicode(os.environ.get("NEO4J_HOST", 'http://localhost'))
neo4j_port = unicode(os.environ.get("NEO4J_PORT", 7474))
neo4j_pair = unicode("http://localhost:7474/db/data")
